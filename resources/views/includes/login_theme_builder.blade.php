      ...
      <div class="customizer-content p-3 ps-container ps-theme-dark" data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a">
        ...
        <div class="ct-bg-image">
          ...
          <div class="cz-bg-image row sb-bg-img">
            <div class="col-2 px-2"><img class="rounded sb-bg-01" src="{{asset('app-assets/img/sidebar-bg/01.jpg')}}" alt="sidebar bg image" width="90"></div>
            <div class="col-2 px-2"><img class="rounded sb-bg-02" src="{{asset('app-assets/img/sidebar-bg/02.jpg')}}" alt="sidebar bg image" width="90"></div>
            <div class="col-2 px-2"><img class="rounded sb-bg-03" src="{{asset('app-assets/img/sidebar-bg/03.jpg')}}" alt="sidebar bg image" width="90"></div>
            <div class="col-2 px-2"><img class="rounded sb-bg-04" src="{{asset('app-assets/img/sidebar-bg/04.jpg')}}" alt="sidebar bg image" width="90"></div>
            <div class="col-2 px-2"><img class="rounded sb-bg-05" src="{{asset('app-assets/img/sidebar-bg/05.jpg')}}" alt="sidebar bg image" width="90"></div>
            <div class="col-2 px-2"><img class="rounded sb-bg-06" src="{{asset('app-assets/img/sidebar-bg/06.jpg')}}" alt="sidebar bg image" width="90"></div>
          </div>
